...
let Iconmingpiannor = ({ size, color, ...rest }) => {
  return (
...
Iconmingpiannor.defaultProps = {
  size: 18,
};

Iconmingpiannor = React.memo ? React.memo(Iconmingpiannor) : Iconmingpiannor;

export default Iconmingpiannor;
